...
set.seed(17)
error <- mclapply(d_, calculate_error_iter_hill_sample, x_y_df_stationary = hill_tbl, intended_x_bar = 50, intended_y_bar = 50, intended_gamma = 0.1, intended_true_n = 5, intended_true_K = 70, samp_size = 10^5, mc.cores = 160)
...
setwd("..//..")
write.csv(design_matrix, "hill-function-sample_50_50_0.1_5_70_10-5_1000.csv", row.names = FALSE)
